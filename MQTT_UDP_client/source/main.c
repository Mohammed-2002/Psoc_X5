...
bool wifi_connected = false;  // Initialize the global variable
...
int main()
{
    ...
    xTaskCreate(udp_client_task, "UDP Task", UDP_CLIENT_TASK_STACK_SIZE, NULL, UDP_CLIENT_TASK_PRIORITY, &client_task_handle);
